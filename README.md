...
Final Weekly Premium = Base Tier
                       × Zone Risk Multiplier (0.85 to 1.40)
                       × Season Factor (1.00 normal | 1.15 summer | 1.25 monsoon)
                       × Claim History Modifier (0.95 clean | 1.10 one claim | 1.30 two or more)
                       × GigScore Discount (1.00 new | 0.95 score 700+ | 0.90 score 850+)
```

Example for Ravi on the Standard plan during monsoon in Kondapur with a GigScore of 720:
Rs.39 × 1.20 × 1.25 × 1.00 × 0.95 = **Rs.55.6, rounded to Rs.56 per week.**
...
| Heatwave | Feels-like temperature exceeds 42°C during active shift | Environmental |
...
```
Payout = Average Hourly Earning × Disrupted Hours × Coverage Ratio
...
The following events are **not covered** under any ZeroShield plan:

- **War & Civil Unrest** — Acts of war, invasion, armed conflict, civil war, rebellion, or non-weather government emergencies. Civic disruptions under Section 144 are covered only if declared for weather or public health reasons.
- **Pandemic & Epidemic Events** — WHO-declared pandemic lockdowns, state-imposed epidemic quarantine zones, or income loss due to rider personal illness. Zone-level AQI spikes due to industrial pollution remain covered.
- **Acts of God Beyond Trigger Scope** — Earthquakes, volcanic eruptions, tsunamis, sinkholes, and solar flares. Flood and heavy rain ARE covered.
- **Wilful Negligence & Misconduct** — Voluntary zone abandonment, platform suspension due to personal misconduct, or earnings loss from traffic violations.
- **Pre-existing Zone Disputes** — Zone boundary changes or dark store relocations announced before the policy week. Zone changes after policy activation are covered for up to 72 hours.
- **Excluded Technical Events** — Personal device failure, personal data plan outage, or scheduled platform maintenance announced 24 hours prior. Platform-wide outages affecting more than 80% of zone orders for more than 20 minutes remain fully covered.

### Actuarial Sustainability Model

| Metric | Year 1 | Year 2 | Year 3 |
|--------|--------|--------|--------|
| Active Riders | 50,000 | 1,50,000 | 3,00,000 |
| Weekly Premium Pool | Rs.2.25 Crore | Rs.6.75 Crore | Rs.13.5 Crore |
| Target Loss Ratio | 52% | 48% | 44% |
| Weekly Claims | Rs.1.17 Crore | Rs.3.24 Crore | Rs.5.94 Crore |
| Net Weekly Margin | Rs.1.08 Crore | Rs.3.51 Crore | Rs.7.56 Crore |

**Break-even point:** 12,400 active riders — reachable in Month 3 of Phase 1.

**Reserve Fund Structure:**
- Seed Reserve: Rs.50 Lakhs (covers 4.3 weeks of Year 1 claims)
- Weekly Reserve Contribution: 8% of premium pool
- Catastrophe Buffer: Rs.1.5 Crore for simultaneous multi-zone events
- Reinsurance Trigger: Activated when loss ratio exceeds 75%
- GigScore Impact: High-score riders file 18% fewer fraudulent claims
- Fraud Shield Savings: Rs.32 Lakhs/year estimated from Isolation Forest model

**Premium allocation breakdown:**
- 52% — Claims payouts
- 21% — Actuarial safety margin
- 12% — Operating costs (tech + ops + fraud detection)
- 8% — Reinsurance premium
- 8% — Reserve contribution
- 9% — Net profit margin
...
**GigScore — Financial Identity for Gig Workers**
India's gig workers have no formal credit history. GigScore (300–900) is built from claim accuracy, platform tenure, and shift consistency. High-score riders receive premium discounts and access to microloans through partner NBFCs. This is the first financial identity product built exclusively for gig workers and is scalable beyond insurance into lending and other financial products.

**Smart Advisor AI**
Every Sunday, each rider receives a personalized risk forecast for their zone with actionable shift timing advice. ZeroShield does not just protect income — it helps riders optimize it.

**Health Alert System**
When AQI or heat crosses safety thresholds even below payout trigger levels, riders receive proactive health alerts. ZeroShield protects income and health simultaneously.

**Emergency Feature**
A one-tap emergency button in the app sends the rider's GPS location to their emergency contacts and alerts them to the nearest safe zone. This is triggered automatically during extreme weather or curfew events.
